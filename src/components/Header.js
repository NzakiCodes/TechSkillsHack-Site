            ...
            <header id="home" className="w3-display-container paralax paralax6 w3-padding-32">
                        <div className="w3-display-left w3-text-white" style={{padding:"48px"}}>
                           ...
                           <div className="w3-hide-large w3-hide-medium"> <span className="w3-large ">Stop Wasting Time Doing Nothing.</span>
                            ...
                            <p>
                            <a href="#about" className="w3-margin w3-round w3-xxlarge w3-button primary-background w3-opacity w3-padding-large w3-hover-opacity-off w3-large w3-margin-top ">
                                    Join Us
                                </a>
                                <a href="#about" className="w3-margin w3-round w3-xxlarge w3-button primary-color w3-yellow w3-opacity w3-hover-opacity-off w3-padding-large w3-large w3-margin-top ">
                                    Learn More
                                </a>
                            </p>
                </div>
